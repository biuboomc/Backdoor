...
parser.add_argument('--epoch', type=int, default=50, help='the number of epoch for training')
parser.add_argument('--schedule', type=int, nargs='+', default=[100, 150],
                    help='Decrease learning rate at these epochs.')
parser.add_argument('--save-every', type=int, default=10, help='save checkpoints every few epochs')
